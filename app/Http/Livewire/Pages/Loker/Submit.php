...
namespace App\Http\Livewire\Pages\Loker;
...
class Submit extends Component
{
    ...
    public function render()
    {
        ...
        $this->proposal = proposal::where('id_users', $this->users_id)->where('id_lokers', $this->loker['id_lokers'])->first();
        $this->wishlist = wishlist::where('users_id', $this->users_id)->where('lokers_id', $this->loker['id_lokers'])->first();
        return view('livewire.pages.loker.submit');
    }
}
