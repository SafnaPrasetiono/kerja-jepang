<div>
    <div class="d-block bg-white rounded shadow mb-4">
        <div class="d-flex align-items-center px-4 py-3 border-bottom">
            <p class="fs-4 fw-bold mb-0">Sertifikat</p>
        ...
        <div class="p-4">
            @if($DataSertif != null)
            <a href="/documents/certificate/{{ $DataSertif->certificate }}" class="link-primary text-decoration-none"
                target="_blank" download="">
                <i class="fas fa-file fa-sm fa-fw me-1"></i>
                {{ $DataSertif->certificate }}
            </a>
            @else
            <div class="d-flex flex-column flex-md-row mb-3">
                ...
                <div class="ms-0 ms-md-3 text-center text-md-start">
                    <p class="fs-4 fw-bold mb-0 ">Oops, Belum ada Sertifikat</p>
                    <p class="fs-5">Tambahkan Serifikat</p>
                </div>
            </div>
            @endif
        </div>
    ...
    <div wire:ignore.self class="modal fade" id="certificateModal" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3 placeholder-glow">
                        ...
                        <input wire:model="certificate" type="file"
                ...
                <div class="modal-footer">
                    ...
                    <button wire:click.prevent="store" type="button" class="btn btn-primary" wire:target='certificate'
                        wire:loading.remove>Save changes</button>
                    <button class="btn btn-primary" type="button" disabled wire:loading.block wire:target='certificate'
                        wire:target="store">
    ...
    <script>
        ...
        document.addEventListener('showCertificate', function () {
            $('#certificateModal').modal('show');
        });

        document.addEventListener('expandCertificate', function () {
