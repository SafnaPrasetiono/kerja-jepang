<div>
        ...
        <div class="p-4">
            ...
            <div class="d-flex mb-3">
                <div class="">
                    ...
                    <p class="mb-0 text-secondary"><span class="text-capitalize">{{ $items->month_start }}</span> {{ $items->years_start }} - <span class="text-capitalize">{{ $items->month_end }}</span> {{ $items->years_end }}</p>
                </div>
                <div class="d-flex align-items-start ms-auto">
                    <button wire:click='edit({{ $items->id_experience }})' type="button" class="btn btn-outline-secondary">
                        <i class="fas fa-pencil-alt fa-sm fa-fw"></i> Edit
                    </button>
                    <button wire:click='remove({{ $items->id_experience }})' type="button" class="btn btn-outline-danger ms-2">
            ...
            <div class="d-flex flex-column flex-md-row mb-3">
                ...
                <div class="ms-0 ms-md-3 text-center text-md-start">
                    ...
                    <p class="fs-5">Tambahkan Pengalaman Kerja</p>
                </div>
            </div>
            @endif
        </div>
    ...
    <div wire:ignore.self class="modal fade" id="experience" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Pengalaman Kerja</h5>
                ...
                <div class="modal-body">
                    <div class="mb-3 placeholder-glow">
                        ...
                        <input wire:model="position" type="text"
                            class="form-control @error('position') is-invalid @enderror" wire:target="store"
                    ...
                    <div class="mb-3">
                        ...
                        <input wire:model="company" type="text"
                            class="form-control @error('company') is-invalid @enderror" wire:target="store"
                            wire:loading.class="placeholder disabled">
                        @error('company')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-md-6">
                                <select wire:model='month_start' class="form-select">
                            ...
                            <div class="col-12 col-md-6">
                                <select wire:model='years_start' class="form-select">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2">
                            <div class="col-12 col-md-6">
                                <select wire:model='month_end' class="form-select">
                                    <option selected value=''>Bulan</option>
                                    <option value='janaury'>Janaury</option>
                                    <option value='february'>February</option>
                                    <option value='march'>March</option>
                            ...
                            <div class="col-12 col-md-6">
                                <select wire:model='years_end' class="form-select">
                                    <option value=''>Tahun</option>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input wire:model='status' class="form-check-input" type="checkbox" value="2" id="flexCheckDefault">
    ...
    <script>
        document.addEventListener('deleteConfrimed', function () {
            Swal.fire({
                ...
                text: "Menghapus data pengalaman kerja anda!",
                icon: "warning",
        ...
        document.addEventListener('showExperience', function () {
            $('#experience').modal('show');
        });

        document.addEventListener('expandExperience', function () {
