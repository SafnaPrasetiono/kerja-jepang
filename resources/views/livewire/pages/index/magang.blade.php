    ...
    <div class="py-4">
        <div class="container">
            <div class="d-flex align-items-center mb-4">
                <div>
                    <h4 class="fw-bold">Ex. Magang Jepang</h4>
                    <p class="mb-0 text-secondary">Yuk, cari informasi magang dijepang</p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-center py-4">
                            ...
                            <h2 class="fw-light">Belum terdapat informasi mengenai magang jepang</h2>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('magang.detail', ['slug' => $item->slug]) }}"
