<div>
    <div class="container-fluid">
        <div class="d-flex align-items-center bg-white shadow p-3">
            <div class="p-3" style="width: 270px">
                <img src="{{ url('/images/icons/password.png') }}" alt="" class="img-fluid">
            </div>
            <div class="ms-0 ms-md-4">
                <p class="fs-5 fw-bold">Change your password account</p>
                <p class="text-secondary mb-0">Your Account</p>
                <p class="mb-4">{{ auth('admin')->user()->email }}</p>
                <button wire:click='show' type="button" class="btn btn-outline-primary rounded-0">Set Password</button>
            </div>
        </div>
    </div>
