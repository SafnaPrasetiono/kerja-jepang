<div>
	<div class="d-flex align-items-center py-3">
		...
		<button class="btn btn-primary btn-sm px-3 ms-auto" wire:click='show'>Tambah</button>
	</div>
	<div class="table-responsive">
		<table class="table table-borderless">
			...
			<tbody>
				...
				<tr>
					<th>{{ $index + 1 }}</th>
					<td><img src="{{ url('/images/banner/'. $item->banners_sm) }}" alt="" width="120px" class="rounded"></td>
					<td><img src="{{ url('/images/banner/'. $item->banners_lg) }}" alt="" width="260px" class="rounded"></td>
					<td>
