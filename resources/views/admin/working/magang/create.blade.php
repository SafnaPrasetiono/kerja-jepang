...
@section('head')
<title>kerjajepang - buat lowongan magang</title>
<style>
    .ck-editor__editable {
        min-height: 200px;
...
<div class="container-fluid">
    <div class="d-block rounded bg-white shadow-sm p-3 mb-3">
        <p class="fs-4 fw-bold mb-0">Tambah Lowongan Magang</p>
        <p class="mb-0 text-secondary">Halaman tambah data baru lowongan magang</p>
    </div>
    <div class="d-block rounded bg-white shadow-sm p-3 mb-3">
