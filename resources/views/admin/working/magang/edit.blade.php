...
@section('head')
<title>kerjajepang - Edit lowongan magang</title>
<style>
    .ck-editor__editable {
        min-height: 200px;
...
<div class="container-fluid">
    <div class="d-block rounded bg-white shadow-sm p-3 mb-3">
            <p class="fs-4 fw-bold mb-0">Edit Lowongan Magang</p>
    ...
    <div class="d-block rounded bg-white shadow-sm p-3 mb-3">
        ...
        <form action="{{ route('admin.magang.update', ['id' => $data->id_lokers]) }}" method="post"
